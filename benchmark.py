...
def run_round(generator, model_path, quant_file, n_generate, context, input_ids, batch_size, no_safetensors, pretrained):
    ...
    if pretrained:
        ...
        model = AutoAWQForCausalLM.from_quantized(
            model_path, quant_file, max_seq_len=n_generate+context, batch_size=batch_size, fuse_layers=False
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="meta-llama/Llama-3.2-1B", help="path to the model")
    parser.add_argument("--quant_file", type=str, default="Llama-3.2-1B-AWQ-gemv", help="weights filename")
