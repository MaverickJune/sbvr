...
class WeightQuantizer(torch.nn.Module):
    ...
    # TODO: This should be better refactored into `forward`, which applies 
    # quantize and dequantize. A new method `quantize` should be added 
    # (if needed) to return the quantized integers and scales, 
    # like in ActQuantizer.
    def quantize(self, x):
        x_dtype = x.dtype
